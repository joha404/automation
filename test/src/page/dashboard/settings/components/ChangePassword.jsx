              ...
              >
                ...
                <div className="pt-4">
                  <SubmitButton
                    ...
                    className={`w-full ${
                      theme === "light"
                        ? "border-[#0A9087] bg-[#0A9087] shadow-[0_12px_24px_rgba(10,144,135,0.18)] hover:bg-[#08726C] hover:border-[#08726C] hover:shadow-[0_16px_30px_rgba(10,144,135,0.22)] before:bg-[#08726C]"
                        : ""
                    }`}
                    variant="bg_my"
                  >
