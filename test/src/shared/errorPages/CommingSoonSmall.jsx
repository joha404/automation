          ...
          >
            {Object.entries(timeLeft).map(([unit, value]) => (
              <div key={unit} className="text-center bg-darkestGrey">
                <div className="text-xl sm:text-2xl  font-bold text-mediumBlue bg-mediumBlack px-4 py-2 rounded-lg">
                  {value.toString().padStart(2, "0")}
                </div>
                <div className="text-xs  text-mediumGrey mt-2 uppercase">
                  {unit}
                </div>
              </div>
            ))}
...
export default CommingSoonSmall;
