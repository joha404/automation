  ...
  return (
    <CommonWrapper>
      <div className={`rounded-xl font-primary  shadow-sm   `}>
        ...
        >
          <div className="flex items-center justify-center gap-2 lg:gap-6 w-full my-2 lg:my-1">
            {/* Text */}
            <CommonTitle
              variant="regular"
              className="text-[#0A9087] !mb-0 ml-4 lg:ml-5 text-center leading-none whitespace-nowrap"
            >
