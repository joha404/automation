...
const SubmitButton = ({
  ...
  const variants = {
    ...
    bg_my:
      "border border-[#0F6C65] bg-[#054844] text-white shadow-[0_12px_24px_rgba(3,59,55,0.22)] hover:-translate-y-0.5 hover:bg-[#065e57] hover:border-[#18b8ae] hover:text-white hover:shadow-[0_16px_30px_rgba(10,144,135,0.24)]",
  ...
  return (
    <button
      ...
      className={cn(
        ...
        variant === "bg_my" ? "before:bg-[#0c6f68]" : "before:bg-[#03635d]",
      )}
