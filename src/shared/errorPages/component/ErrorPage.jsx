        ...
        <div className="flex items-center justify-center min-h-[calc(100vh-160px)]">
          ...
          >
            ...
            <button
              ...
              className="bg-[#0A9087]  text-white px-6 py-3 rounded-md text-sm cursor-pointer shadow-sm transition-colors duration-300 transform hover:bg-[#0A9087]/90 w-[200px]"
            >
              {buttonText}
            </button>
          </div>
