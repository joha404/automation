...
const InputField = ({
  ...
  const variants = {
    ...
    bg_black: `bg-darkerBlack xl:px-8 px-5 ${sizeClasses[size]} placeholder:text-mediumGrey text-lighterGrey dark-theme border-2 border-lightBlack ${sizeClasses[size]} ${phone? "xl:ps-16 ps-16" : ""}`,
  };
