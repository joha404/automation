    ...
    <div className="min-h-screen bg-[#032422] relative overflow-visible z-10">
      <div className="relative  max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 pt-12 pb-10">
        ...
        <div className="flex justify-center absolute left-0 right-0 -top-20 lg:-top-10 px-4 sm:px-6 lg:px-8 ">
          <div className="w-full max-w-[749px] bg-gradient-to-r from-[#0A4F49] via-[#0c5c55] to-[#0A4F49] rounded-2xl border border-[#1E7C76]/40 shadow-[0_0_40px_rgba(10,144,135,0.15)]">
        ...
        {/* ── Heading ── */}
        <div className="text-center mt-32 sm:mt-20 mb-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mt-14">
          {features.map((feature, index) => (
            ...
            >
              {/* Mobile: horizontal row layout | Desktop: vertical layout */}
              <div className="flex flex-row sm:flex-col items-start gap-4 sm:gap-0">
                {/* Icon */}
                <div className="relative flex-shrink-0 w-[37px] h-[37px] lg:w-12 lg:h-12 rounded-xl bg-gradient-to-br from-[#0A9087] to-[#065e57] flex justify-center items-center shadow-[0_4px_20px_rgba(10,144,135,0.4)] group-hover:shadow-[0_4px_30px_rgba(10,144,135,0.6)] transition-shadow duration-300 sm:mb-5">
                  <img
                    src={feature.img}
                    alt={feature.title}
        ...
        <div className="mt-10 flex justify-center">
          <div className="w-[215px] h-[44px] rotate-0 opacity-100 gap-[10px] rounded-full pt-[10px] pr-[30px] pb-[10px] pl-[30px] bg-[#0A9087] font-logo text-white font-extrabold text-[16px] leading-[100%] tracking-[0%] text-center flex justify-center items-center cursor-pointer hover:bg-[#087a72] transition-colors duration-300">
            START FREE TRIAL
          </div>
        </div>
      </div>
