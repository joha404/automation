    ...
    >
      <div className="max-w-6xl mx-auto lg:pt-5">
          ...
          <div className="mb-6 lg:hidden">
            <button
              ...
              className={`w-full flex items-center justify-between p-3 rounded-lg ${
                theme === "dark"
                  ? "bg-mediumBlack text-white border border-mediumBlack"
            ...
            <div className="w-full max-w-3xl">
              <div
                className={`relative flex p-1 rounded-lg ${
                  theme === "dark"
                    ? "sm:bg-transparent bg-mediumBlack"
                    : "sm:bg-transparent bg-gray-100"
                }`}
              >
                <motion.div
                  className={`absolute bottom-0 h-0.5 ${
                    theme === "dark" ? "bg-lightBlue" : "bg-mediumBlue"
                  }`}
                  style={{
        ...
        <CommonWrapper>
          ...
          <CommonParagraph variant="small" className="w-full text-center mt-2">
